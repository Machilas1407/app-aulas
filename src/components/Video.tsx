...
// interface GetLessonBySlugesponse {
//     lesson: {
//         title: string;
//         videoId: string;
//         description: string;
...
export function Video(props: VideoProps) {
    // const {data} = useQuery<GetLessonBySlugesponse>(GET_LESSON_BY_SLUG_QUERY, {
    //     variables: {
                    ...
                    <a href="" className="bg-gray-700 rounded overflow-hidden flex items-stretch gap-6 hover:bg-gray-600 transition-colors">
                        ...
                        <div className="py-6 leading-relaxed">
                            ...
                            <p className="text-sm text-gray-200 mt-2">
                                Acesso ao material complementar para acelerar o seu desenvolvimento
                            </p>
                        </div>
