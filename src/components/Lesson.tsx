...
export function Lesson(props: LessonProps) {
    ...
    return(
        <Link to={`/event/lesson/${props.slug}`} onClick={location.reload} className='group'> 
            ...
            {/* <div className={`rounded border border-gray-500 p-4 mt-2 group-hover:border-green-500 ${isActiveLesson ? 'bg-green-500' : '' }`}> uma forma de usar o tailwing com condicional */}
